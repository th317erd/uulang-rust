#[macro_export]
macro_rules! RegexLiteral {
  () => {
    adextopa_core::Map!(
      adextopa_core::Program!("RegexLiteral";
        adextopa_core::Equals!("RegexStart"; "/"),
        adextopa_core::ProxyChildren!(
          adextopa_core::Loop!("RegexCaptureLoop";
            // Match all characters up to: \, /, or [
            adextopa_core::Matches!("Part"; r"[^/\\\[]*"),
            ...
            adextopa_core::Switch!(
              ...
              adextopa_core::ProxyChildren!(
                adextopa_core::Program!(
                  adextopa_core::Equals!("RegexEnd"; "/"),
                  adextopa_core::Matches!("Flags"; r"[gimsU]*"),
                  adextopa_core::Break!("RegexCaptureLoop"),
                )
              ),
              // Is this a character sequence?
              adextopa_core::Sequence!("Part"; "[", "]", "\\"),
            )
          )
        ),
      ),
      |token, _, __| {
        let mut range = adextopa_core::source_range::SourceRange::new(usize::MAX, usize::MAX);
        ...
        adextopa_core::TokenResult!(token.clone())
      }
    )
  };
}
